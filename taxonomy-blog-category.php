    ...
    <div class="p-mv">
      <div class="p-mv__inner">
        <h1 class="p-mv__heading">
          <span class="p-mv__heading-inline-ja"><?php echo get_the_terms(get_the_ID(), 'blog-category')[0]->name; ?></span>
                ...
                <a href="<?php the_permalink(); ?>" class="p-archive-entry__item">
                  ...
                  <div class="p-archive-entry__body">
                    <div class="p-archive-entry__category">
                      ...
                      <div class="p-archive-entry__tag--cat"><?php echo get_the_terms(get_the_ID(), 'blog-category')[0]->name; ?></div><!-- /entry-item-tag -->
                      <!-- /entry-item-tag -->
                    </div>
                    <!-- /entry-item-meta -->
