...
<head prefix="og: https://ogp.me/ns#">
    ...
    <meta charset="UTF-8" />
    <!-- スマホやタブレットでもきれいに表示する「レスポンシブ表示」のための記述です -->
...
<body <?php body_class(); ?>>
    ...
    <header class="l-header" id="js-header">
        <div class="l-header__inner">
            ...
            ?>
                <h1 class="header-logo l-header__logo"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/icon-logo.svg" alt="みなみ歯科クリニック" width="270" height="32" loading="lazy" /></a></h1><!-- /header-logo -->
            <?php else : ?>
                <div class="header-logo l-header__logo"><a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/icon-logo.svg" alt="みなみ歯科クリニック" width="270" height="32" loading="lazy" /></a></div><!-- /header-logo -->
            <?php endif; ?>

            <nav class="l-header__nav u-hidden-sm" id="g-nav-pc">
                <ul class="l-header__nav-list">
                    ...
                    <li class="l-header__nav-item">
                        <a href="<?php
                                    echo esc_html(get_page_link(144));
                                    ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M9 11C11.2091 11 13 9.20914 13 7C13 4.79086 11.2091 3 9 3C6.79086 3 5 4.79086 5 7C5 9.20914 6.79086 11 9 11H9ZM9 5C10.1046 5 11 5.89543 11 7C11 8.10457 10.1046 9 9 9C7.89543 9 7 8.10457 7 7C7 5.89543 7.89543 5 9 5Z" fill="#393939" />
                                <path d="M17 13C18.6569 13 20 11.6569 20 10C20 8.34315 18.6569 7 17 7C15.3431 7 14 8.34315 14 10C14 11.6569 15.3431 13 17 13ZM17 9C17.5523 9 18 9.44772 18 10C18 10.5523 17.5523 11 17 11C16.4477 11 16 10.5523 16 10C16 9.44771 16.4477 9 17 9Z" fill="#393939" />
                                <path d="M17 14C15.8918 14.0012 14.8155 14.3706 13.94 15.05C11.9371 13.0549 8.93071 12.4605 6.31923 13.5431C3.70775 14.6258 2.00382 17.173 2 20C2 20.5523 2.44772 21 3 21C3.55229 21 4 20.5523 4 20C4 17.2386 6.23858 15 9 15C11.7614 15 14 17.2386 14 20C14 20.5523 14.4477 21 15 21C15.5523 21 16 20.5523 16 20C16.0024 18.8284 15.7064 17.6756 15.14 16.65C16.0417 15.9375 17.2713 15.8027 18.306 16.303C19.3406 16.8033 19.9985 17.8507 20 19C20 19.5523 20.4477 20 21 20C21.5523 20 22 19.5523 22 19C22 16.2386 19.7614 14 17 14Z" fill="#393939" />
                            </svg>
                            <span>スタッフ紹介</span>
                        </a>
                    </li>
                ...
                <div class="l-header__contact">
                    <div class="l-header__contact-inner">
                        <p class="l-header__address">〒166-0001 東京都杉並区阿佐谷北7-3-1</p>
    ...
    <div class="c-reserve-btn u-hidden-sm u-hidden-md u-hidden-lg">
        <a href="<?php
                    echo esc_html(get_page_link(140));
                    ?>" class="c-reserve-btn__link"></a>
    </div>