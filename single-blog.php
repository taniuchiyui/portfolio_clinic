        ...
        <main class="p-single-primary">
              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class('entry'); ?>>
                ...
                <div class="entry-header">
                  ...
                  <div class="entry-meta">
                    ...
                    <div class="entry-label"> <?php echo get_the_terms(get_the_ID(), 'blog-category')[0]->name; ?> </div>
                  </div>
                  <!-- /entry-meta -->
                </div>
                <!-- /entry-header -->
          ...
          <div class="entry-btn-wrap">
            ...
            <div class="entry-btn-archive">
              <a class="entry-btn-link" href="<?php echo get_post_type_archive_link('blog'); ?>">記事一覧</a>
            </div>
